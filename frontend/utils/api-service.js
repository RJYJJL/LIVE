...
class ApiService {
  constructor() {
    ...
    this.baseURL = API_BASE_URL || this.config.current || 'http://192.168.43.247:8081';
  ...
  updateConfig(serverUrl) {
    ...
    this.baseURL = serverUrl || API_BASE_URL || 'http://192.168.43.247:8081';
  ...
  async request(options) {
    ...
    const baseUrl = this.baseURL || API_BASE_URL || 'http://192.168.43.247:8081';
      ...
      try {
        ...
        if (urls && urls.play_hls) {
          ...
          if (hlsUrl.includes('localhost')) {
            ...
            const serverIp = serverIpMatch ? serverIpMatch[1] : '192.168.43.247';
          ...
          if (hlsUrl.includes('192.168.43.247:8086')) {
          ...
          if (flvUrl.includes('192.168.43.247:8086')) {
