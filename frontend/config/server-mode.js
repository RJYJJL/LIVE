...
export const MIDDLEWARE_SERVER_URL = 'http://192.168.43.247:8080';  // 网关地址（Node 监听 8080）
export const REAL_SERVER_URL = 'http://192.168.43.247:8000';  // 真实后端（可选直连）
...
// export const API_BASE_URL = MIDDLEWARE_SERVER_URL; // 通过中间层服务器 (http://192.168.43.247:8081)
export const API_BASE_URL = REAL_SERVER_URL; // 直接连接真实后端服务器 (http://192.168.43.247:8000)
